...
\begin{Schunk}
\begin{Sinput}
> plotMDS.dge[width=0.9\textwidth]](d.Li, main="MDS Plot for Li Data",xlim=c(-0.4,0.8))
\end{Sinput}
\end{Schunk}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[height=0.4\textheight]{edgeR_case_study_Li_MDSplot.pdf}
